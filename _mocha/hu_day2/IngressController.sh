...
export CLUSTER_NAME="vitalforge-cluster"
export VPC_ID="vpc-0c9724d43eaed906a"
export REGION="us-east-1"


## Tag subnets for alb
PUBLIC_SUBNETS="subnet-05a364d5ac686fa79 subnet-05502990a431b9e2c"
PRIVATE_SUBNETS="subnet-028da2e9d6156b38f subnet-0505baef89f4ea732"
